...
def user_destination_confirmation():
    ...
    if user_input == "y":
        print("Great! Let's move onto the next option.")
        return random_destination
    elif user_input == "n":
        print("If that is not your prefered choice lets try again!")
...
def customer_confirmed():
    user_verify = input("Would you like to finalize your day trip? y/n ")
    if user_verify == "y":
...
print("Congratulations you have booked a day trip!!")
